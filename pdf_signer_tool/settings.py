...
ROOT_URLCONF = 'pdf_signer_tool.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media',  # Adicionado para acesso a MEDIA_URL nos templates
            ],
        },
    },
]

WSGI_APPLICATION = 'pdf_signer_tool.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'signer/static')]  # Adicionado para arquivos estáticos adicionais
...
# Configurações de tamanho máximo para upload (opcional)
